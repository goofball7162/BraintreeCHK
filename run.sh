...
if [ -d "$HOME/BraintreeCHK" ]; then
    cd "$HOME/BraintreeCHK"
else
    echo "Error: BraintreeCHK directory not found in HOME."
    echo "Place this script inside or above the BraintreeCHK folder."
    exit 1
fi
...
echo ""
echo "=========================================="
echo "   Starting braintreeVBV.py (auto-restart)"
echo "   Press CTRL + C to stop manually."
echo "=========================================="
echo ""

while true; do
    $PY "$HOME/BraintreeCHK/braintreeVBV.py"
    echo ""
    echo ">>> braintreeVBV.py stopped. Restarting in 5 seconds..."
    sleep 5
done
